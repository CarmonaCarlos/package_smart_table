...
class CustomPaginatedDataTable extends StatefulWidget {
  ...
  CustomPaginatedDataTable({
    ...
    required this.onShowDeletedChanged,
  ...
  /// {@macro flutter.screen.scrollable.dragStartBehavior}
  ...
  ///Function to evaluate show deleted items checkbox
  final Function(bool value) onShowDeletedChanged;
          ...
          child: Column(
            ...
            children: <Widget>[
              CheckboxListTile(
                ...
                onChanged: (value) {
                  setState(() {
                    widget.onShowDeletedChanged(!widget.showDeleted);
                  });
                },
              ...
              //TODO: fix The Scrollbar's ScrollController has no ScrollPosition attached exception, this is a problem where flutter team is working on
              Scrollbar(
                  scrollbarOrientation: ScrollbarOrientation.bottom,
                  controller: _scrollController,
                  isAlwaysShown: MediaQuery.of(context).size.width < 800,
